...
$sid='';
if(isset($_GET['sid'])) $sid='&sid='.$_GET['sid'];
if(($_SERVER['REQUEST_URI']=='/ucp.php?mode=register'||$_SERVER['REQUEST_URI']=='/ucp.php?mode=register'.$sid) && $_SERVER['REQUEST_METHOD']!='POST')
