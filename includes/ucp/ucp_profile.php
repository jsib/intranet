		...
		switch ($mode)
		{
			...
			case 'profile_info':
				...
				$data = array(
					...
					'officephone'		=> request_var('officephone', $user->data['user_officephone']),
					'extphone'			=> request_var('extphone', $user->data['user_extphone']),
					'workmobilephone'	=> request_var('workmobilephone', $user->data['user_workmobilephone']),
					'privatemobilephone'=> request_var('privatemobilephone', $user->data['user_privatemobilephone']),
				...
				if ($submit)
				{
					...
					if (!sizeof($error))
					{
						...
						$sql_ary = array(
							...
							'user_officephone'	=> $data['officephone'],
							'user_extphone'	=> $data['extphone'],
							'user_workmobilephone'	=> $data['workmobilephone'],
							'user_privatemobilephone'	=> $data['privatemobilephone'],
							'user_aim'		=> $data['aim'],
							'user_msnm'		=> $data['msn'],
							'user_yim'		=> $data['yim'],
				...
				$template->assign_vars(array(
					...
					'EXTPHONE'		=> $data['extphone'],
					'WORKMOBILEPHONE'	=> $data['workmobilephone'],
					'PRIVATEMOBILEPHONE' => $data['privatemobilephone'],
					'YIM'		=> $data['yim'],
					'AIM'		=> $data['aim'],
					'MSN'		=> $data['msn'],
					'JABBER'	=> $data['jabber'],
