...
$lang = array_merge($lang, array(
	...
	'ACP_UPDATETHANKS'					=> 'Updateed recorded thanks',	
	...
	'THANKS_GLOBAL_POST'				=> 'Thanks in Global Announce',
	...
	'THANKS_REFRESH_EXPLAIN'			=> 'Here you can update thanks counters after a mass removal of posts/topics/users, splitting/merging of topics, setting/removing Global Announcement, enable/disable option "Only for the first post in the topic", changing posts owners and etc. This may take some time.<br /><strong>Important: To work correctly, the counters refresh function needs MySQL version 4.1 or later!<br />Attention!<br /> - If you Refresh will erase all thanks to the guest posts!<br /> - If you Refresh will delete all thanks in the Global Announce, if the option `Thanks in Global Announce` OFF!<br /> - When you Refresh will erase all thanks from all positions except the first in the topic, if the option `Only for the first post in the topic` ON!</strong>',
